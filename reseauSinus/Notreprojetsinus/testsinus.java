...
public class testsinus {
    ...
    public static void main( String[] args ) throws IOException, InterruptedException
    {
    	...
    	//Save the model
        File locationToSave = new File("Sinus.zip");      //Where to save the network. Note: the file is in .zip format - can be opened externally
	...
	private static MultiLayerNetwork fitStraightline(DataSet ds){
		...
		MultiLayerConfiguration conf = new  NeuralNetConfiguration.Builder()
                ...
                .list()
                .layer(0, new DenseLayer.Builder().nIn(numInputs).nOut(num)
                        .activation(Activation.SIGMOID)
                        .build())
                .layer(1, new OutputLayer.Builder(LossFunctions.LossFunction.MSE)
                        .activation(Activation.IDENTITY)
                        .nIn(num).nOut(numOutputs).build())
